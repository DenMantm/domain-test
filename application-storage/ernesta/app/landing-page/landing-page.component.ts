...
import { APP_PATH } from '../../configuration.js'


@Component({
    templateUrl:APP_PATH+'app/landing-page/landing-page.component.html',
    styleUrls:[APP_PATH+'app/landing-page/landing-page.component.css']
})
